...
public class WinDefeatMenu {
    ...
    HUDButton soundSelectorButton;
    HUDButton musicSelectorButton;
    ...
    public WinDefeatMenu (Level level, Camera camera)
    {
        ...
        // Buttons
        soundSelectorButton = new HUDButton("SelectorImage"    , new Vector2(150,120),
                new Vector2(0.8f,0.8f), HUDElement.Anchor.MiddleScreen, HUDButton.ButtonType.Sound    ,level, camera);

        musicSelectorButton = new HUDButton("SelectorImage"    , new Vector2(150,20),
                new Vector2(0.8f,0.8f), HUDElement.Anchor.MiddleScreen, HUDButton.ButtonType.Music    ,level,  camera);
